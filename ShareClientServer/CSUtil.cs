...
//        public static void SendDPO(NetworkStream networkStream, Test test)
//        {
//            if (test != null)
//            {

//                byte[] prefixSend = BitConverter.GetBytes(ObjectToByteArray(test).Length);
//                byte[] bytesSend = ObjectToByteArray(test);
//                byte[] bufferSend = new byte[prefixSend.Length + bytesSend.Length];
...
//        public static Byte[] ReadDPO(NetworkStream networkStream)
//        {
//            byte[] bufferRead; // = new byte[256];
//            int totalRead = 0;
//            byte[] messagebytesRead = new byte[4];
